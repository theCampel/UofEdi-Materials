...
--m1 = mkFSM [0,1,2,3,4] "ab" [ (0,'a',1), (0,'b',1), (0,'a',2), (0,'b',2), (1,'b',4), (2,'a',3), (2,'b',3), (3,'b',4), (4,'a',4), (4,'b',4) ] [0] [4]  
...
dfinal  fsm@(FSM qs as ts ss fs) supers = filterS (`elem` fromList[fs]) supers -- Basically filter out everything thats not fa using
